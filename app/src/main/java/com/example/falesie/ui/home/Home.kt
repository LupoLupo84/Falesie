package com.example.falesie.ui.home
        ...
        LazyColumn{
            ...
            items(homeState.items){
                val dismissState = rememberDismissState(
                    confirmValueChange = { value ->                         //tutorial confirmStateChange
                ...
                SwipeToDismiss(
                    ...
                    dismissContent = {
                        ShoppingItems(
                            ...
                            onChechedChange = homeViewModel::onItemCheckChange
                        ) {
...
fun ShoppingItems(
    ...
    isChecked: Boolean,
    onChechedChange:(Item,Boolean) -> Unit,
    onItemClick: () -> Unit
){
    Card(
        modifier = Modifier
        ...
        Row(
            ...
            Column(modifier = Modifier.padding(8.dp)) {
                ...
                Checkbox(
                    checked = isChecked,
                    onCheckedChange = {
                                      onChechedChange.invoke(item.item, it)
                    },
                )
            }
        }
