                ...
                Button(onClick = {
                                 auth.signInWithEmailAndPassword(email, password)
                                     .addOnCompleteListener{
                                         if (it.isSuccessful){
                                             Log.d("Firebase", "The user has successfully loged in")
                                             email = ""
                                             password = ""
                                             Toast.makeText(context, "The user has successfully loged in", Toast.LENGTH_LONG ).show()
                                             //TODO AVVIARE LA SCHERMATA PRINCIPALE DELL'APPLICAZIONE
                                         }else{
                                             Log.w("Firebase", "The user has FAILED to log in", it.exception)
                                             email = ""
                                             password = ""
                                             Toast.makeText(context, "The user has FAILED to log in " +
                       ...
                       auth.createUserWithEmailAndPassword(email, password)
                           .addOnCompleteListener{
                               if (it.isSuccessful){
                                   ...
                                   Log.w("Firebase", "The user has FAILED to create account", it.exception)
                                   email = ""
                                   password = ""
                                   Toast.makeText(context, "The user has FAILED to create account " +
                                           " ${it.exception.toString()}", Toast.LENGTH_LONG ).show()
                               }
                           }
            },
